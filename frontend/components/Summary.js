...
export default function Summary() {
  ...
  return (
    <div class="">
      ...
      <div class="flex items-center justify-center pt-16 pb-10 gap-10">
        <div class="bg-white text-gray-800 rounded-lg shadow-sm p-10  w-1/2 h-full">
          <div class="flex flex-wrap  items-center">
            <div class="w-full sm:w-1/2 md:w-3/4 text-left pb-64">
              <div class=" ">
                <h3 class="text-4xl ">
                  Welcome back,{" "}
        ...
        <div class="flex flex-col w-1/2">
          <div class="bg-red-100  text-gray-800 rounded-lg shadow-sm p-10 px-10 h-56">
            {/* <div
              class="bg-cover bg-center relative  w-24 h-24"
              style={{
                backgroundImage: `url(${asparagus})`,
              }}
            ></div> */}
          </div>
          <div class=" text-gray-800 rounded-lg    py-10  h-56">
            <div class="flex gap-10">
              <div class="w-1/2 bg-white h-56 rounded-lg p-10 shadow-sm">
                <span class="text-3xl  font-medium text-gray-800">
                  Open orders
                </span>
              </div>
              <div class="w-1/2 bg-white rounded-lg p-10 shadow-sm">hi</div>
            </div>
          </div>
        </div>
      </div>
      {/* fic */}
      {/* <SummaryHeader /> */}
      <div class="flex justify-between items-baseline rounded-lg pt-8 pb-4">
